...
import { TyeNode } from 'src/views/tyeServicesProvider';
...
export interface TelemetryProvider {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    registerContextCommandWithTelemetry<T extends TyeNode>(commandId: string, callback: (context: IActionContext, node: T | undefined, ...args: any[]) => unknown): void;
}
